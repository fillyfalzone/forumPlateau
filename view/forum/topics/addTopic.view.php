...
<form action="index.php?ctrl=forum&action=createTopic" method="post" style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5; border: 1px solid #ddd; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <input type="text" name="title" id="title" placeholder="Entrez le titre" style="width: 100%; padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 3px; font-size: 16px;">

    <label for="message" style="font-weight: bold; display: block; margin-bottom: 10px;">Décrivez votre topic :</label>
    <textarea name="message" id="message" cols="30" rows="10" style="width: 100%; padding: 10px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 3px; font-size: 16px;"></textarea>

    <label for="user" style="font-weight: bold; display: block; margin-bottom: 10px;">Choisissez un utilisateur :</label>
    <select name="user" id="user" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 3px; font-size: 16px; margin-bottom: 20px;">
